module.exports = function(grunt) {
    ...
    grunt.initConfig({
        concat: {
            browserconfig: {
                src: ['./node_modules/nightwatch-base-page/lib/browser-config/browserconfig.json'],
                dest: 'browserconfig.json'
            },
            chrome: {
                src: ['./node_modules/nightwatch-base-page/lib/browser-config/nightwatch_chrome.conf.js'],
            ...
            dockerfirefox: {
                src: ['./node_modules/nightwatch-base-page/lib/browser-config/docker-firefox-conf.js'],
                dest: 'docker-firefox-conf.js'
            },
            dockerphantomjs: {
                src: ['./node_modules/nightwatch-base-page/lib/browser-config/docker-phantomjs-conf.js'],
